...
import { ChevronLeft, ChevronRight, Maximize2, Battery, Zap, Shield, Thermometer, ArrowRight, X } from 'lucide-react';
...
const BatteryDetails = () => {
  ...
  // Specific galleries for different Inverter batteries
  if (battery?.id === 'inv-12.8v-100ah') {
    images = [
      { src: battery?.image, alt: 'Main View', label: 'Main View' },
      { src: '/images/batteries/2.png', alt: 'Longer Life', label: 'Longer Life' },
      { src: '/images/batteries/3.png', alt: 'Applications & Features', label: 'Applications & Features' },
      { src: '/images/batteries/4.png', alt: 'Power Never Stops', label: 'Power Never Stops' },
      { src: '/images/batteries/5.png', alt: 'Designed to Perfection', label: 'Designed to Perfection' },
      { src: '/images/batteries/6.png', alt: 'Additional View', label: 'Additional View' }
    ];
  } else if (battery?.id === 'inv-25.6v-100ah') {
    images = Array.from({ length: 6 }, (_, i) => ({
      src: `/images/batteries/100Ah 25.6V/${i + 1}.png`,
      alt: `View ${i + 1}`,
      label: i === 0 ? 'Main View' : `View ${i + 1}`
    }));
  } else if (battery?.category === 'Inverter') {
    images = [
      { src: battery?.image, alt: 'Main View', label: 'Main View' }
    ];
  }
